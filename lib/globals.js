...
global.log = bunyan.createLogger({name: 'NPlate'});
...
*/
global.varDump = function(variable, userOptions) {
	var options = {
		showHidden: true,
		depth: 4,
		colors: false
 ...
 * @param "options" [optional] [object] - options for 'util'
*/
global.consoleDump = function(variable, userOptions) {
	var options = {
		showHidden: true,
		depth: 4,
		colors: true
